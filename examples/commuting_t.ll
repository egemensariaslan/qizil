; T gates separated by CNOTs whose control leg is diagonal: the commutation
; pass slides them together so the Clifford+T pass can fold T*T -> S.
; ModuleID = 'commuting_t'
source_filename = "commuting_t"
